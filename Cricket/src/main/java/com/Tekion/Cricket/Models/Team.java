...
public class Team {
    ...
    private final List<Players> batters = new ArrayList<>();
    private final List<Players> bowlers = new ArrayList<>();
    private final List<Players> allPlayers = new ArrayList<>();
     ...
     */
    public void addBatter(Players player){
        batters.add(player);
     ...
     */
    public Players[] getBatters(){
        Players[] arr = new Players[batters.size()];
     ...
     */
    public void addBowlers(Players player){
        bowlers.add(player);
        allPlayers.add(player);
    }
     ...
     */
    public Players[] getBowlers() {
        Players[] arr = new Players[bowlers.size()];
